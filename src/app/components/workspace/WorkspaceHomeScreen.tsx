...
import type { Project, Workspace, AuthUser, User, Member } from '../../../types';
...
export function WorkspaceHomeScreen({ workspace, user, onSelectProject, onBack, onLogout }: WorkspaceHomeScreenProps) {
